<template>
  <v-card class="elevation-0 transparent">
    ...
    <div
      class="col-12 pa-0 px-2 d-flex flex-row justify-space-between rounded-lg"
    ...
    <div class="d-flex flex-row flex-wrap">
      <div
        v-for="truck in getItemsWithKey('OcrMatch')"
        :key="truck.id"
        class="cursor-pointer my-1 rounded-lg col-6 pa-1"
        style="position: relative"
        @click="$emit('select', truck)"
      >
        <img
          :style="'border: 2px solid ' + statusColor(truck)"
